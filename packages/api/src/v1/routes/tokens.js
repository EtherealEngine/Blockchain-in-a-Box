...
const {getBlockchain, areAddressesCollaborator} = require('@blockchain-in-a-box/common/src/blockchain.js');
const {makePromise, setCorsHeaders} = require('@blockchain-in-a-box/common/src/utils.js');
const {getRedisItem, parseRedisItems, getRedisClient} = require('@blockchain-in-a-box/common/src/redis.js');
const {
...
const {encodeSecret, decodeSecret} = require('@blockchain-in-a-box/common/src/encryption.js');
