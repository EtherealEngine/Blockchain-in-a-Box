#!/bin/bash
dfxDir="/home/syed/.config/dfx"
candidDir="/home/syed/DIP721/nft/candid"
...
deploy() {
  eval "sudo dfx deploy cap"
  principal=$(sudo dfx identity get-principal)
  ...
  eval "sudo dfx deploy nft --argument '(principal \"$principal\", \"tkn\", \"token\", principal \"$cap_principal\")'"
}
